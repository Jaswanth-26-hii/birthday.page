...
<body>
  <div class="card" id="card">
    ...
    <header>
      ...
      <div>
        ...
        <div class="sub">A little surprise I made just for you — click the button below 🎁</div>
      </div>
    </header>
    ...
    <div class="hero">
      <div class="left">
        <div class="message">
          <div class="typed" id="typed">Press "Open Surprise" to reveal something special…</div>
        ...
        <div class="controls">
          <div class="control">🎵 <label style="cursor:pointer"><input id="musicToggle" type="checkbox"> Play music</label></div>
    ...
    <footer>
      <div class="small">Made with ❤️ — Customize the name & message in the code.</div>
  ...
  <script>
    ...
    const SURPRISE_MESSAGE = [
      ...
      "Can't wait to celebrate with you — happy birthday! 🎂"
    ];
    ...
    avatar.textContent = (FRIEND_NAME.trim().length>0)?FRIEND_NAME.trim().charAt(0).toUpperCase(): '🎉';
